...
import styles from './HotlineComponent.module.scss';
import { images } from '../../assets';
import BoxPhoneComponent from './BoxPhoneComponent/BoxPhoneComponent';
                                ...
                                <div className={cx('tab-container', 'employer')}>
                                    <div className={cx('col','service')}>
                                        <div className={cx('service-phone')}>
                                            ...
                                            <BoxPhoneComponent full_name="Hotline 1" phone="0123 456 789" />
                                            <BoxPhoneComponent full_name="Hotline 2" phone="0123 456 789" />
                                        </div>
                                        <div className={cx('service-email')}>
                                            <p className={cx('title')}>Email hỗ trợ nhà tuyển dụng</p>
                                            <BoxPhoneComponent phone="tungong@email.com" />
                                        </div>
                                    </div>
                                    <div className={cx('col','hotline-col')}>
                                        ...
                                        {listHotline
                                            ...
                                            .slice(0, 5)
                                            .map((item) => (
                                                <BoxPhoneComponent key={item.id} full_name={item.full_name} phone={item.phone} />
                                            ))}
                                    </div>
                                    <div className={cx('col','hotline-col')}>
