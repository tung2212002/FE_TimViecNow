...
import { selectIsAuth } from '../../redux/features/auth/authSlide';
import { loginService, testLogout } from '../../services/authService';
            ...
            <div className={cx('container')}>
                ...
                {isAuth ? (
                    <ul className={cx('navbar-right')}>
                        ...
                        <li className={cx('avatar-container')} onClick={handleTestLogout}>
                            <div className={cx('avatar-bg')}>
                                <a to="/login" className={cx('avatar-link')}>
                                    ...
                                    <span className={cx('text')}>Ong Thế Tùng</span>
                            ...
                            <div className={cx('account-menu')}>
                                <NavBarMenuComponent>
                                    {accountItems.map((item, index) => (
                                        <NavBarMenuItemComponent key={index} icon={item.icon} label={item.label} to={item.to} addHr={item.addHr} />
                                    ))}
                                </NavBarMenuComponent>
                            </div>
                        </li>
                    ...
                    <ul className={cx('navbar-right')}>
                        <li className={cx('btn', 'login-btn')} onClick={handleTestLogin}>
                            <span className={cx('text')}>Đăng nhập</span>
                        </li>
                        <li className={cx('btn', 'register-btn')} onClick={handleCheckAuth}>
