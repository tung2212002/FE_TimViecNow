...
import styles from './DashboardPostJobDistrictCampaign.module.scss';
...
const DashboardPostJobDistrictCampaign = ({ location_id, province_id, district_id }) => {
...
DashboardPostJobDistrictCampaign.propTypes = {
    location_id: PropTypes.number,
    province_id: PropTypes.number,
    district_id: PropTypes.number,
};

export default DashboardPostJobDistrictCampaign;
