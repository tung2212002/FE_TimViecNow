...
import styles from './SuggestCourseSlideComponent.module.scss';

const cx = classNames.bind(styles);

const SuggestCourseSlideComponent = () => {
    const fakeData = {
        status: 'success',
        courses: [
            {
...
SuggestCourseSlideComponent.propTypes = {};

export default SuggestCourseSlideComponent;
