...
import styles from './JobSearchDetailBodySummaryComponent.module.scss';
import { icons } from '../../../../assets';

const cx = classNames.bind(styles);

const JobSearchDetailBodySummaryComponent = ({ job }) => {
...
JobSearchDetailBodySummaryComponent.propTypes = {
    job: PropTypes.object.isRequired,
};

export default JobSearchDetailBodySummaryComponent;
