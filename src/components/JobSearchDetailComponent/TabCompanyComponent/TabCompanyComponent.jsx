...
import styles from './TabCompanyComponent.module.scss';

const cx = classNames.bind(styles);

const TabCompanyComponent = ({ handleToInfo, handleToCompany, handleToRelated, state }) => {
    useEffect(() => {
...
export default TabCompanyComponent;
