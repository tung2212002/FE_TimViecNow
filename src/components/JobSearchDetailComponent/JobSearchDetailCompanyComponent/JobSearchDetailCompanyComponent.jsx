...
import styles from './JobSearchDetailCompanyComponent.module.scss';

const cx = classNames.bind(styles);

const JobSearchDetailCompanyComponent = ({ company }) => {
    return (
...
JobSearchDetailCompanyComponent.propTypes = {
    company: PropTypes.object.isRequired,
};

export default JobSearchDetailCompanyComponent;
